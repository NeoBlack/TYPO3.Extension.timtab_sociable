...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/timtab_sociable/pi1/class.tx_timtabsociable_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/timtab_sociable/pi1/class.tx_timtabsociable_pi1_wizicon.php']);
}
